package com.sscp.core.testcontext.mocks;
...
public class MockHtmlLibraryManager implements HtmlLibraryManager {
    ...
    public static final String LIB_PATH = "/apps/testing/clientlibs/test";
    ...
    public Collection<ClientLibrary> getLibraries(String[] strings, LibraryType libraryType, boolean b, boolean b1) {
        ...
        lenient().when(mockClientLibrary.getCategories()).thenReturn(new String[]{"test.clientlib"});
    ...
    @Override
    public Set<String> getLibrariesPaths(String[] categories) {
        return null;
    }
