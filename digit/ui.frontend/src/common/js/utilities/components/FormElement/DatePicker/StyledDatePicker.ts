...
import { body2, boldBody2, fixedBody14, fixedBody16 } from '@/utility/styles/text';

export const StyledDiv = styled.div<{ alignLeft: boolean; hasError?: any }>`
  width: 100%;
  position: relative;
  ...
  .popperContainer {
    ...
    .react-datepicker {
      float: ${({ alignLeft }) => (alignLeft ? 'left' : 'right')};
      width: 100%;
      min-width: 340px;
      max-width: 468px;
      box-sizing: border-box;
    ...
    .react-datepicker__day--selected {
      background-color: ${({ theme }) => theme.colors.button.primary['default-1']};
    }

    .react-datepicker__day--selected:hover {
      background-color: ${({ theme }) => theme.colors.button.primary['hover-1']};
    }
