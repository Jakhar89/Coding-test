...
export default {
  ...
  colors: {
    ...
    reversed: {
      ...
      borderColor: 'transparent',
      borderImage: colors.button.reversed['gradient-border'],
      borderActive: null,
    ...
    secondary: {
      ...
      borderColor: 'transparent',
      borderImage: colors.button.secondary['gradient-border'],
      borderActive: null,
      borderHover: colors.button.secondary['hover-2'],
      color: colors.button.secondary['default-3'],
      colorActive: null,
