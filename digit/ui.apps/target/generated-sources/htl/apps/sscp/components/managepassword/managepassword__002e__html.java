 ...
 * under the License.
 ******************************************************************************/
package apps.sscp.components.managepassword;
...
public final class managepassword__002e__html extends RenderUnit {
...
out.write("\r\n");
_global_model = renderContext.call("use", com.sscp.core.models.ManagePassword.class.getName(), obj());
_global_errorsuccessmodel = renderContext.call("use", com.sscp.core.models.ErrorSuccessModel.class.getName(), obj());
out.write("<div react-component component-name=\"ManagePassword\"");
{
