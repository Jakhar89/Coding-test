 ...
 * under the License.
 ******************************************************************************/
package apps.sscp.components.header;
...
Object _global_isauthor = null;
Object _global_model = null;
Object _global_errorsuccessmodel = null;
Object _dynamic_wcmmode = bindings.get("wcmmode");
Object _dynamic_component = bindings.get("component");
out.write("\r\n");
_global_isauthor = renderContext.call("use", "../scripts/authormode.js", obj());
out.write("\r\n");
_global_model = renderContext.call("use", com.sscp.core.models.Header.class.getName(), obj());
_global_errorsuccessmodel = renderContext.call("use", com.sscp.core.models.ErrorSuccessModel.class.getName(), obj());
out.write("<div react-component component-name=\"Header\"");
{
    Object var_attrvalue0 = renderContext.call("xss", _global_isauthor, "text");
    {
        boolean var_shoulddisplayattr3 = ((!"".equals(var_attrvalue0)) && (!((Object)false).equals(var_attrvalue0)));
        if (var_shoulddisplayattr3) {
            out.write(" data-is-author-mode");
            {
...
{
    Object var_attrvalue4 = renderContext.getObjectModel().resolveProperty(_global_model, "json");
    {
...
{
    Object var_attrvalue8 = renderContext.getObjectModel().resolveProperty(_global_errorsuccessmodel, "json");
    {
...
out.write(">\r\n</div>\r\n");
{
    Object var_testvariable12 = ((renderContext.getObjectModel().toBoolean(renderContext.getObjectModel().resolveProperty(_dynamic_wcmmode, "edit")) ? renderContext.getObjectModel().resolveProperty(_dynamic_wcmmode, "edit") : renderContext.getObjectModel().resolveProperty(_dynamic_wcmmode, "design")));
    if (renderContext.getObjectModel().toBoolean(var_testvariable12)) {
        out.write("\r\n    <div class=\"cq-placeholder\"");
        {
            Object var_attrvalue13 = renderContext.getObjectModel().resolveProperty(_dynamic_component, "title");
            {
