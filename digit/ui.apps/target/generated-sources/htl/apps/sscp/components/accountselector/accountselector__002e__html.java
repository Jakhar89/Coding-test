 ...
 * under the License.
 ******************************************************************************/
package apps.sscp.components.accountselector;
...
public final class accountselector__002e__html extends RenderUnit {
...
out.write("\r\n");
_global_model = renderContext.call("use", com.sscp.core.models.AccountSelector.class.getName(), obj());
_global_errorsuccessmodel = renderContext.call("use", com.sscp.core.models.ErrorSuccessModel.class.getName(), obj());
out.write("<div react-component component-name=\"AccountSelector\"");
{
